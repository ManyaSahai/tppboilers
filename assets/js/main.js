! function (e) {
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function () {
        ...
        return this.each((function () {
            ...
            if (s.on("click", (function (t) {
                    t.preventDefault();
                    var s = e(this);
                    if (s.addClass("active").siblings().removeClass("active"), c(s), a.sliderTab) {
                        var n = s.index();
                        o.slideTo(n)
                    }
                })), a.sliderTab) {
    ...
    function p() {
        ...
        (function () {
            ...
            function s(s) {
                s = s.split(",");
                for (var n = 0; n < s.length; n++) t = c + " " + s[n], e(t).val() ? (e(t).removeClass("is-invalid"), a = !0) : (e(t).addClass("is-invalid"), a = !1)
            }
    ...
    e.fn.sectionPosition = function (t, a) {
        e(this).each((function () {
            ...
            s = Math.floor(l.height() / 2), n = l.attr(t), i = l.attr(a), o = h(e(i).css("padding-top")), r = h(e(i).css("padding-bottom")), "top-half" === n ? (e(i).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(i).css("padding-top", o + s + "px"), l.css("margin-bottom", "-" + s + "px"))
        }))
    };
    ...
    function m() {
        e(".feature-circle .progressbar").each((function () {
            ...
            a < s + e(window).height() - 30 && !i && (e(this).data("animate", !0), e(this).find(".circle").circleProgress({
    ...
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function () {
        ...
        maxTilt: 7,
        perspective: 1e3
    }), m(), e(window).scroll(m), e("#ship-to-different-address-checkbox").on("change", (function () {
    ...
    e(".pricing-tabs").length && (C.addEventListener("click", (function () {
        x.checked = !1, C.classList.add("toggler--is-active"), k.classList.remove("toggler--is-active"), T.classList.remove("hide"), P.classList.add("hide")
    })), k.addEventListener("click", (function () {
        x.checked = !0, k.classList.add("toggler--is-active"), C.classList.remove("toggler--is-active"), T.classList.add("hide"), P.classList.remove("hide")
    })), x.addEventListener("click", (function () {
        k.classList.toggle("toggler--is-active"), C.classList.toggle("toggler--is-active"), T.classList.toggle("hide"), P.classList.toggle("hide")
    }))),
